import { Namespace, Operation, DecoratorContext, Program, Type } from "@typespec/compiler";
...
export function getApi(program: Program, target: Namespace): string | undefined {
...
export function getBackend(program: Program, target: Operation): string | undefined {
